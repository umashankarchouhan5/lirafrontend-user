    ...
    export default {
        ...
        computed: {
            ...
            formattedToInteger: {
                ...
                set (value) {
                    value = value !== '' && value !== null  ? parseInt(value.replace(/,/g, '')) : '';
                    this.innerValue = value !== '' && value !== null && !isNaN(parseInt(value)) ? parseInt(value) : '';
                }
            },
        },
        mounted() {
