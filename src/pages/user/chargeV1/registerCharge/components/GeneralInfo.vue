<template>
    <div>
        <FormRow>
            <div class="col-sm-4" v-if="$route.query.ibc">
                <InputText label="IBC Name" v-model="$route.query.ibc" readonly rules="required" />
            </div>
            <div class="col-sm-8">
                <AddressInput label="IBC Address" v-model="innerValue.address_id" readonly rules="required" />
            </div>
        </FormRow>
        <FormRow>
            <div class="col-sm-4">
                <InputText label="Charge Title" v-model="innerValue.ChargeTitle" readonly rules="required" />
            </div>
            <div class="col-sm-4">
                <InputDate label="Charge Registration Date" vid="ChargeRegistrationDate" :options="options" readonly v-model="innerValue.ChargeDate" rules="required" />
            </div>
            <div class="col-sm-4">
        ...
        <FormRow>
            ...
            <div class="col-sm-4">
                <FormSelect label="Charge Type" v-model="innerValue.ChargeType_id" readonly disabled rules="required" :items="chargeTypeArr" item-value="id" item-name="DisplayName" />
            </div>
        </FormRow>
        <FormRow>
            <div class="col-sm-4">
            ...
            <div class="col-sm-4">
                <InputDate label="Date of Instrument" vid="DateofInstrument" :options="options" readonly v-model="innerValue.InstrumentDate" rules="required" />
            </div>
            <!-- <div class="col-sm-4">
                <InputText  label="Liability Secured Amount" readonly v-model="innerValue.LiabilitySecured" rules="required" />
            </div> -->
        </FormRow>
        <FormRow>
            <div class="col-sm-6">
