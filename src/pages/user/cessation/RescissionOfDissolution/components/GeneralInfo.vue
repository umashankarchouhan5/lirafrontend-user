<template>
    <div>
        ...
        <FormRow >
            <div class="col-sm-3">
                <InputText :readonly="readonly" label="Liquidator Name"  v-model="innerValue.liquidatorName"  />
            </div>
            <div class="col-sm-7">
                <InputText :readonly="readonly" label="Liquidator Address"  v-model="innerValue.liquidatorAddress"  />
            </div>
        </FormRow>
    </div>
</template>
