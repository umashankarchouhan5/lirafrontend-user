    ...
    <FormRow :class="$style.widthStyle">
        ...
        <div v-if=" value.FieldType.toLowerCase() !== 'table' ">
            ...
            <div :class="$style.flexClass"  v-if="value.FieldType.toLowerCase() !== 'textarea' && value.FieldType.toLowerCase() !== 'yesno' && value.FieldType.toLowerCase() !== 'checkbox' " >
                ...
                <!-- Inputs Start-->
                <div :class="$style.inputsStyle" class="col-sm-4" :style="{width: getTextBoxWidth()}" v-if="value.FieldType.toLowerCase() === 'textbox'">
                    <div>
                ...
                <div :class="[$style.inputsStyle,$style.dateClass]" class="col-sm-4"  v-if="value.FieldType.toLowerCase() === 'date'" >
                ...
                <div :class="[$style.inputsStyle,$style.numberClass]" class="col-sm-4" v-if="value.FieldType.toLowerCase() === 'number'">
                ...
                <div :class="$style.inputsStyle" class="col-sm-4" v-if="value.FieldType.toLowerCase() === 'dropdown'">
                    ...
                    <FormSelect :name="value.Label" :vid="`${value.Label}-${value.Field_id}`" v-model="value.ValueTextArea" 
                ...
                <div :class="[$style.inputsStyle,$style.countryClass]" class="col-sm-4" v-if="value.FieldType.toLowerCase() === 'country'" >
                ...
                <div :class="[$style.inputsStyle,$style.phoneClass]" class="col-sm-4" v-if="value.FieldType.toLowerCase() === 'phone'" >
                ...
                <div :class="[$style.inputsStyle,$style.emailClass]" class="col-sm-4"  v-if="value.FieldType.toLowerCase() === 'email'">
