<template>
    <FormWrapper>
        <PageTitle title="FSP Application Form – Instructions" slot="title" link="/help/701" />
        <div>
...
<script>
    ...
    export default {
        ...
        methods:{
            nextStep(){
                validateICSPInitial({process_id: APPLICATION_OF_FSP }).then(
                    res => {
            ...
            fetchInstruction(){
                fetchInstructions({process_id: APPLICATION_OF_FSP }).then(
                    res=>{
