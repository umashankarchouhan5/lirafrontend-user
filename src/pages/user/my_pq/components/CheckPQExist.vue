    ...
    <ValidationObserver ref="validator">
        <CenterBlock :width="800">
            ...
            <div :class="$style.search">
                <FormRow>
                    <div class="col-sm-6">
                        <InputText v-model="userData.email" label="Email" rules="required" readonly />
                    </div>
                    <div class="col-sm-4">
                        <InputText v-model="PassportNo" :max-length="20" label="Passport Number" rules="required|alphaNumCustom"  />
                    </div>
                </FormRow>
                ...
                <div >
                    <FormRow>
                        ...
                        <div class="col-sm-5">
                            <InputText v-model="userData.Fname" label="First Name" rules="required" readonly />
                        </div>
                        <div class="col-sm-5">
                            <InputText v-model="userData.Lname" label="Last Name" rules="required" readonly />
                        </div>
                    </FormRow>
                    <FormRow>
                        <div class="col-sm-6">
...
<script>
    ...
    import { checkPQexistencebyEmail } from '../config/requests';
                ...
                this.$refs.validator.validate().then((res) => {
                    if (res) {
                        const data = {
                            ...
                            salutaion: this.userData.Salutation,
