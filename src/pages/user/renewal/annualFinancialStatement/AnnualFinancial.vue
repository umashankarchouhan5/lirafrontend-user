<template>
    <FormWrapper>
        <PageTitle title="Annual Financial Statement" slot="title"/>
        <ValidationObserver ref="validator">
            ...
            <FormRow>
                <!-- <div class="col-sm-4">
                    <FormSelect label="Quarter"  v-model="form.qtr" :items="quaters" itemName="name" itemValue="val" :clearable="false" rules="required"/>
                </div> -->
                <div class="col-sm-2">
                ...
                <div class="col-sm-6">
                    <div :class="$style.excelFile">
                        ...
                        <div :class="$style.excelFileInput">
                            <InputFile :rules="{uploadRequired:true,docCheck:'xls,xlsx',checkFileRegex: true}" :value="form.image"  name="UploadField" label="Select File" @onChange="fileXSLSUploadHandler"/>
...
<script>
    ...
    import { ANNUAL_FINANCIAL_SECURITY, ANNUAL_FINANCIAL_INSURANCE, ANNUAL_FINANCIAL_GAMBLING } from 'Config/processIds';
    ...
    export default {
        ...
        created(){
            ...
            if( this.$route.name == 'AnnualReturnGambling'){
                this.$store.commit('setProcessId', ANNUAL_FINANCIAL_GAMBLING);
                this.getData();
            }
            else if( this.$route.name == 'AnnualReturnSecurity'){
                this.$store.commit('setProcessId', ANNUAL_FINANCIAL_SECURITY);
                this.getData();
            }
            else{
                this.$store.commit('setProcessId', ANNUAL_FINANCIAL_INSURANCE);
                this.getData();
            }
        },
        watch: {
