<template>
    <FormWrapper>
        <PageTitle title="CSL/PCC Change Request" v-if="processId !==  null && processId !== 0 && processId !== undefined" slot="title"  :link="`/help/${processId}/${activeStep.id}`" />
        <PageTitle title="CSL/PCC Change Request" v-else slot="title" link="/help/380" />
        ...
        methods: {
            ...
            setMode() {
                if(this.$route.params.id && this.$route.params.id != 'add' && this.$route.params.id != 'edit'){
                    ...
                    this.firstPage = this.$route.path === '/changesCSL_PCC/edit' ? true : false;
                    return this.mode = this.$route.path === '/changesCSL_PCC/edit' ? 'edit' : 'add';
                }
            },
            getPcWebData(){
                getPcWeb({
            ...
            handleData(response){
                    ...
                    this.process_ids = response[0].data;
            },
            fetchCspList() {
            ...
            backToList() {
                ...
                this.$router.push({ path: '/changesCSL_PCC' })
            },
            resetActivatedSteps(){   
