<template>
    <FormWrapper>
        <PageTitle title="CSl/PCC Change Request" slot="title" :link="`/help/380`"/>
        ...
        methods: {
            ...
            respondChange() {
                if (this.validateSelectedLength(1) && this.validateCanRespond()) {
                    ...
                    this.$router.push({ path: `changesCSL_PCC/${reference_id}/respond/${process_id}`})
                }
            },
            validateCanRespond() {
            ...
            addChange() {
                this.$router.push({ path: '/changesCSL_PCC/add' })
            },
			editChange() {
                if (this.validateSelectedLength(1) && this.validateCanEdit()) {
                    ...
                    sessionStorage.setItem(PROCESS_ID, Process_id);
                    sessionStorage.setItem(REFERENCE_ID, reference_id);
                    this.$router.push({ name: 'ChangesCSLPCC_edit'})
                }
            },
            pageChange(page) {
