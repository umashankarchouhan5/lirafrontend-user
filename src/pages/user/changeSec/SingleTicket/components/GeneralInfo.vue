<template>
    <div>
        ...
        <FormRow>
            ...
            <div class="col-sm-3">
                <InputDate label="Effective Date" rules="required" :readonly="readonly" v-model="innerValue.effectiveDate" />
            </div>
        </FormRow>
        <template v-if="innerValue.process_id === 2048">
            <FormRow>
                <div class="col-sm-3">
                    <InputMonth name="Financial Year End Month" label="Old Financial Year End Month" readonly :clearable="true" v-model="licenseData.FinancialYearEndMM" />
                </div>
            </FormRow>
            <FormRow>
                <div class="col-sm-3">
                    <InputMonth name="New Financial Year End Month" label="New Financial Year End Month" :readonly="readonly" :clearable="true" v-model="innerValue.financialYearEndMM" rules="required" />
                </div>
            </FormRow>
        </template>
        ...
        <template v-if="innerValue.process_id === 2041">
            ...
            <FormRow v-if="licenseData.AuditorJson !== undefined">
                <div class="col-sm-12">
                    <Records v-if="licenseData.AuditorJson !== null" v-model="licenseData.AuditorJson" readonly />
                    <Records v-else v-model="BlankAuditorData" readonly />
                </div>
            </FormRow>
            ...
            <FormRow>
                <div class="col-sm-12">
                    <Records  v-model="innerValue.auditorJson" :readonly="readonly" isRequired />
                </div>
            </FormRow>
        </template>
        <template v-if="innerValue.process_id === 2042">
            ...
            <FormRow v-if="licenseData.LegalJson !== undefined">
                <div class="col-sm-12">
                    <Records v-if="licenseData.LegalJson !== null" v-model="licenseData.LegalJson" readonly />
                    <Records v-else v-model="BlankLegalData" readonly />
                </div>
            </FormRow>
            ...
            <FormRow>
                <div class="col-sm-12">
                    <Records v-model="innerValue.legalJson" :readonly="readonly" isRequired />
                </div>
            </FormRow>
        </template>
        <template v-if="innerValue.process_id === 2043">
            <h4>Old Banker Data</h4>
            <br />
            <FormRow v-if="licenseData.BankerJson !== undefined">
                <div class="col-sm-12">
                    <BankerRecords v-if="licenseData.BankerJson !== null" v-model="licenseData.BankerJson" readonly />
                    <BankerRecords v-else v-model="BlankBankerData" readonly />
                </div>
            </FormRow>
            ...
            <FormRow>
                <div class="col-sm-12">
                    <BankerRecords v-model="innerValue.bankerJson" :readonly="readonly" isRequired />
                </div>
            </FormRow>
        </template>
            ...
            getChangeRequest(){
                fetchLicenseeData({license_id: this.innerValue.license_id}).then(
                    res => {
                        ...
                        this.licenseData.BankerJson = JSON.parse(this.licenseData.BankerJson);
                    }
                )
            }
        }
