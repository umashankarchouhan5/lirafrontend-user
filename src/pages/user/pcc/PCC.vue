    ...
    export default {
        ...
        methods:{
            ...
            responseHandler(data){
                ...
                this.$store.commit('setProcessId', APPLICATION_OF_PCC);
            ...
            getDataToSend(nextStep){
                const { process_id,ConvertedCompany_id,ConvertedCompanyName,CompanyName,IncorporationDate,IncorporationCountry_id,ICSPRegNo,ValidPage,BusinessStrategy,OtherActivity,financialYearEndMonth } = this.form.data;
                const data = {
                    process_id,
